...
comida se conoce el nombre que la identifica, el tiempo de preparación,
y los ingredientes que lleva y en qué cantidades. De los ingredientes se
...
biológicos de cada persona, y eventualmente, de quienes son les xadres
adoptivos.
...
5. Hallar las claves e indicar en qué forma normal se encuentra la
...
1. Escribir una función que reciba un número de legajo y que devuelva el
nombre y apellido de le alumne.

2. Escribir una función que reciba un mid, un bid y una fecha, y que
...
3. Escribir una función que reciba une marine y que diga si alquiló
todos los botes.

4. Escribir una función que reciba dos bebedores y que muestre todos los
